...
echo "auto increment updated";}
            ...
            }else{ echo" you don't have permission to delect it";}             
            }else if($change=='1'){
...
<body>
    ...
    $c=$_SESSION['user_id'];
    $sql="INSERT INTO `question$pid`( `aname`, `acmmnt`,`uid`) VALUES ('$a','$b','$c')";
...
?>
	...
	<form class="form-horizontal" method="post" action="">
       <label class="control-label" for="email">Comment:</label><textarea name="cmmnt"></textarea>
