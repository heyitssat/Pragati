...
function newDoc() {
    ...
    window.location.assign("changepass.php?user='+nam+'")
}
</script>
*/
...
if(isset($_SESSION['signed_in']) && $_SESSION['signed_in'] == true)
{
    ...
    echo '<br><a href="changepass.php"><br>Change Your password</a>       <br><p id ="error"></p>';
}
else
{
    if($_SERVER['REQUEST_METHOD'] != 'POST')
...
//        echo '<br><input type="button" value="Change Your password" onclick= "newDoc()"><br><br><p id ="error1"></p>';
        
echo '<button type="button" class="btn btn-primary" style="width:20%" onclick="newDoc()" id="but" value="1">Change your Password</button><br><p id ="error1"></p>';
        echo'Not have any account. <a href="signup.php">Create an account</a><br>';
        ...
        else
        {
            ...
            else
            {
                ...
                if(mysqli_num_rows($result) == 0)
                {
                    ...
                    <a href="">Try again</a>
                    <br>Not having any account,<a href="signup.php"> Sign Up</a>';
                }
                else
                {
   ...
   //                 echo $_SESSION['user_name']  ;
                    ...
                    echo '<br><a href="changepass.php">Change your password</a><br><p id="error"></p>';
                    }
                }
            }
        }
